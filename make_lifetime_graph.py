...
rects2 = ax1.bar(X_axis+width, Y_ske_lt, width, color='lightcoral')
#ax1.set_title('Lifetime Distribution')
ax1.set_ylabel('Percent of population')
ax1.set_xlabel('Lifetime (hours)')
ax1.legend((rects1[0],rects2[0]), ('Activists', 'Deniers'))

plt.savefig("analysis/lifetime_2.eps", format="eps")
plt.show()
